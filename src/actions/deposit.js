...
var deposit = function (from, amountLamports, reserve, reserveAddress, connection, wallet) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          authority = _b.sent()[0];
          fromAccount = account_1.ensureSplAccount(
            instructions,
            cleanupInstructions,
            from,
            wallet.publicKey,
          ...
          return [
            4 /*yield*/,
            account_1.findOrCreateAccountByMint(
              wallet.publicKey,
              wallet.publicKey,
              instructions,
              cleanupInstructions,
        ...
        case 5:
          if (isInitalized) {
            ...
            instructions.push(
              lending_1.initReserveInstruction(
                amountLamports,
                MAX_UTILIZATION_RATE,
                fromAccount,
                toAccount,
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            connection_1.sendTransaction(connection, wallet, instructions.concat(cleanupInstructions), signers, true),
          ];
        case 7:
          tx = _b.sent();
          return [
