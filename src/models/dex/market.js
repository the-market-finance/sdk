...
var DexMarketParser = function (pubkey, acc) {
  var market = serum_1.MARKETS.find(function (m) {
    return m.address.equals(pubkey);
  });
  var decoded = serum_1.Market.getLayout(
    (market === null || market === void 0 ? void 0 : market.programId) || DEFAULT_DEX_ID,
  ).decode(acc.data);
  var details = {
    pubkey: pubkey,
    account: __assign({}, acc),
