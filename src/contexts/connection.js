...
var getErrorForTransaction = function (connection, txid) {
...
var sendTransaction = function (connection, wallet, instructions, signers, awaitConfirmation) {
  if (awaitConfirmation === void 0) {
