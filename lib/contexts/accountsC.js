...
exports.cache = {
    ...
    byParser: function (parser) {
        ...
        var result = [];
        try {
            for (var _b = __values(exports.keyToAccountParser.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var id = _c.value;
...
var getMultipleAccounts = function (connection, keys, commitment) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.all(utils_1.chunks(keys, 99).map(function (chunk) { return getMultipleAccountsCore(connection, chunk, commitment); }))];
            case 1:
                result = _a.sent();
                array = result
                    .map(function (a) {
