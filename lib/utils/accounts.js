...
var accountEmitter = new EventEmitter();
...
export var TokenAccountParser = tokenAccountFactory;
...
export var getCachedAccount = function (predicate) {
    var e_1, _a;
    try {
        for (var _b = __values(accountsCache.values()), _c = _b.next(); !_c.done; _c = _b.next()) {
