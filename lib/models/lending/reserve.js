...
var initReserveInstruction = function (liquidityAmount, maxUtilizationRate, from, // Liquidity input SPL Token account. $authority can transfer $liquidity_amount
...
var reserveMarketCap = function (reserve) {
    ...
    var borrowed = utils_1.wadToLamports(reserve === null || reserve === void 0 ? void 0 : reserve.borrowedLiquidityWad).toNumber();
    var total = available + borrowed;
    return total;
};
exports.reserveMarketCap = reserveMarketCap;
var collateralExchangeRate = function (reserve) {
    return ((reserve === null || reserve === void 0 ? void 0 : reserve.collateralMintSupply.toNumber()) || 1) / exports.reserveMarketCap(reserve);
};
