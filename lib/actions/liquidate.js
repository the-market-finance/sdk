...
export var liquidate = function (connection, wallet, from, // liquidity account
amountLamports, // in liquidty token (lamports)
// which loan to repay
obligation, repayReserve, withdrawReserve) { return __awaiter(void 0, void 0, void 0, function () {
    var signers, instructions, cleanupInstructions, accountRentExempt, _a, authority, fromAccount, toAccount, dexMarketAddress, dexMarket, market, dexOrderBookSide, memory, tx;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                toAccount = _b.sent();
                dexMarketAddress = repayReserve.info.dexMarketOption
                ...
                market = cache.get(withdrawReserve.info.lendingMarket);
                dexOrderBookSide = market.info.quoteMint.equals(repayReserve.info.liquidityMint)
                ...
                instructions.push(liquidateInstruction(amountLamports, fromAccount, toAccount, repayReserve.pubkey, repayReserve.info.liquiditySupply, withdrawReserve.pubkey, withdrawReserve.info.collateralSupply, obligation.pubkey, authority, dexMarketAddress, dexOrderBookSide, memory));
