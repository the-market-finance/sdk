...
function createTempMemoryAccount(instructions, payer, signers, space = exports.DEFAULT_TEMP_MEM_SPACE) {
...
signers, excluded) {
    ...
    const account = accountsC_1.cache
        .byParser(accountsC_1.TokenAccountParser)
        .map((id) => accountsC_1.cache.get(id))
